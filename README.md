<h1 align = "center"> <i> "Do not let what you cannot do interfere with what you can do" <i> </h1>
  ...
  <p> <img src="Leadership.png" alt="An Image of Lightbulb Symbol" width = "35px" height = "35px">  Earning my master's degree in battery power consumption enhancements.
  </p>
  
  <p> <img src="Leadership.png" alt="An Image of Lightbulb Symbol" width = "35px" height = "35px">  A Ph.D. in a field relevant to the improvement of battery behavior.
  </p>
  
  <p> <img src="Leadership.png" alt="An Image of Lightbulb Symbol" width = "35px" height = "35px">  If accepted, contribute yearly to an open-source project through GSoC
    or other programs. </p>
