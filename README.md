<h1 align = "center"> <i> "Do not let what you cannot do interfere with what you can do" <i> </h1>
  ...
  <p> <img src="Light.png" alt="An Image of Lightbulb Symbol" width = "40px" height = "40px">  If accepted, contribute yearly to an open-source project through GSoC
    or other programs. </p>
  
    <p> <img src="Light.png" alt="An Image of Lightbulb Symbol" width = "20px" height = "20px">  If accepted, contribute yearly to an open-source project through
      GSoC or other programs. </p>
